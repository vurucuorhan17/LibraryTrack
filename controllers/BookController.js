            ...
            .then((book) => {
                if (req.session.userId || req.user) {
                    if(req.user)
                    {
                        if(!book)
                        {
                            res.render("site/books/mostRent",{user:req.user,socialProfile:true});
                        }
                    ...
                    else if(req.session.userId)
                    {
                        if(!book)
                        {
                            res.render("site/books/mostRent",{user:true,socialProfile:false});
                        }
                    ...
                    {
                        res.render("site/books/mostRent",{user:false});
                    }
                }
                else {
                    res.status(404);
